...
Layout
  ...
  //-     div(class="md:w-1/2 px-8 mb-8 md:mb-0 md:order-1")
  //-         g-image(src="~/assets/images/7_Firmenkurse_iStock-620402800.jpg" alt="" class="md:max-w-sm mx-auto" fit="inside" height="250" )
