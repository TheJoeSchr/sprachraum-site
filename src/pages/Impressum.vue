...
Layout
  ...
  p
    strong Aufsichtsbehörde/Gewerbebehörde:
  ...
  p
    ...
    |           Analyse der Benutzung der Website durch Ihre Benutzer ermöglicht. Die
  ...
  p
    ...
    | und/oder  (berechtigtes Interesse) der DSGVO.
  p
