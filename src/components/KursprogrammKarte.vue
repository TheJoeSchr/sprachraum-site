...
section(class="py-0")
  .flex.flex-wrap.max-w-4xl.mx-auto
    .w-full.py-1.mb-1.px-2(class='md:w-full md:mb-0')
      .py-1.border
        div.ml-auto.text-center(class='md:mx-32 w-2/5')
          p.mb-2.leading-relaxed.text-sm.py-1.px-3.mt-1.mr-2.text-black.font-secondary.bg-secondary-200.rounded-full.
            {{ value.days }}
        ...
        h3.text-lg.pl-3.mb-3.font-heading.font-semibold.left-0(class="w-full") {{value.name}}
          ...
          div.pr-3.text-md.text-gray-900.w-full.text-right
